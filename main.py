...
from src.file_reader import read_excel_transaction
...
def get_transactions(user_input: str) -> Any:
    ...
    if user_input == "1":
        ...
        transactions = read_csv_transaction("../data/transactions.csv")
        return transactions
    elif user_input == "3":
        transactions = read_excel_transaction("../src/transactions_excel.xlsx")
        return transactions
...
if user_input_3.lower() == "да":
    ...
    user_input_4 = input()
    if (
        user_input_4.lower() != "по возрастанию"
        and user_input_4.lower() != "по убыванию"
    ):
...
def get_transactions_list_by_date(
    transactions: List[Dict], user_input_4: str, user_input_sort: str
) -> Any:
    if user_input_4.lower() == "да":
...
transactions_step_3 = get_transactions_list_by_date(
    transactions_step_2, user_input_3, user_input_4
)
...
def get_transactions_list_RUB(transactions: List[Dict], user_input_5: str) -> Any:
    new_transactions = []
    if user_input_5.lower() == "да":
...
def get_transactions_list_by_word(
    transactions: List[Dict], user_input_7: str, word: str
) -> Any:
    """По необходимости возвращает только операции, в описании которых есть введенное слово"""
    if user_input_7.lower() == "да":
        new_transactions = search_by_string(transactions, word)
        return new_transactions
    elif user_input_7.lower() != "да":
        return transactions


transactions_step_5 = get_transactions_list_by_word(
    transactions_step_4, user_input_6, user_input_7
)
